...
Function AddMultiYearExpenseAccountsFromTB1(ws As Worksheet, TB1Sheet As Worksheet, ByRef row As Long, ByRef previousYearTotal As Double) As Double
    ...
    costOfGoodsSold = GetCostOfGoodsSoldFromTB1(TB1Sheet)
    costOfGoodsSoldPrevious = GetCostOfGoodsSoldFromTB1Previous(TB1Sheet)
...
Function GetCostOfGoodsSoldFromTB1(TB1Sheet As Worksheet) As Double
    Dim lastRow As Long
    Dim i As Long
    ...
    For i = 2 To lastRow
        If TB1Sheet.Cells(i, 2).Value = "1510" Then
            ...
            If cogsCount = 2 Then
                GetCostOfGoodsSoldFromTB1 = TB1Sheet.Cells(i, 4).Value ' Column D for cost of goods sold
                Exit Function
            End If
        End If
    Next i
    
    GetCostOfGoodsSoldFromTB1 = 0 ' Return 0 if second occurrence of 1510 is not found
End Function

Function GetCostOfGoodsSoldFromTB1Previous(TB1Sheet As Worksheet) As Double
    Dim lastRow As Long
    Dim i As Long
    Dim cogsCount As Integer
    ...
    For i = 2 To lastRow
        If TB1Sheet.Cells(i, 2).Value = "1510" Then
            cogsCount = cogsCount + 1
            If cogsCount = 2 Then
                GetCostOfGoodsSoldFromTB1Previous = TB1Sheet.Cells(i, 3).Value ' Column C for previous year
                Exit Function
            End If
        End If
    Next i
    
    GetCostOfGoodsSoldFromTB1Previous = 0 ' Return 0 if second occurrence of 1510 is not found
End Function
...
Sub CreateMultiPeriodLiabilityBalanceSheetFromTB1(ws As Worksheet, TB1Sheet As Worksheet)
    ...
    Else
        ...
        tempResults = AddMultiPeriodAccountGroupFromTB1(ws, TB1Sheet, row, "", "3010", "3019", "", False, True, True, False)
    End If

    tempResults = AddMultiPeriodAccountGroupFromTB1(ws, TB1Sheet, row, GetRetainedEarningsText(targetWorkbook), "3020", "3020", "", False, True, True, True)
